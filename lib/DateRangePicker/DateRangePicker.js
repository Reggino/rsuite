...
function (_React$Component) {
  ...
  function DateRangePicker(props) {
    ...
    _this.updateValue = function (event, nextValue, closeOverlay) {
      ...
      if (onChange && (selectValue.length && (!nextValue || !nextValue.length) || !(0, _is_same_day.default)(nextValue[0], selectValue[0]) || !(0, _is_same_day.default)(nextValue[1], selectValue[1]))) {
